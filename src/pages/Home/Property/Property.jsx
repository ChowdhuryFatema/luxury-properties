		...
		<div>
			<div className="p-5 max-w-7xl mx-auto mb-10 md:mb-20">
				...
				<div className="grid grid-cols-2 gap-4 md:grid-cols-4">
					<div data-aos="zoom-in" data-aos-duration="1000" className='property col-span-2 md:row-span-2 md:col-start-3 md:row-start-1 bg-gray-500 aspect-square relative'>
					...
					<div className='overlay3'></div>
						<div className='absolute top-1/2 left-2/4 z-50 -translate-x-1/2 -translate-y-1/2 space-y-3'>
