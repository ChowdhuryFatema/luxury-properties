                            ...
                            <div className="flex flex-col border rounded-lg mx-4 my-6 bg-white">
                                <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
                                    <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                                        ...
                                        Assists individuals in obtaining mortgage loans to finance the purchase of residential properties, working with lenders to find suitable terms and rates.
